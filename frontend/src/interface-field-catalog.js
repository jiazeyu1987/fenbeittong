...
export const interfaceFieldCatalog = [
  ...
  row('线下', 'data.expenses[].total_amount', '报销金额', 'FExpenseAmount / FExpSubmitAmount / FOriginalAmount', 'ERP报销金额写分贝通报销金额；报销未付款金额不再由接口赋值'),
  ...
  row('线上', 'repayment_total_amount / amount_due / total_amount / company_pay_price / enterprise_payment_amount', '报销金额', 'FExpenseAmount / FExpSubmitAmount / FOriginalAmount', '取企业账单实际结算金额；报销未付款金额和已付款金额不由工作台赋值'),
